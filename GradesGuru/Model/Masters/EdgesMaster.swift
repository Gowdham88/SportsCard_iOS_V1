...
var EdgeDetails : EdgeMaster = EdgeMaster(device_ID: "", CardID: "", Pictures : ["1","2","3"], SurfaceValue : "", PSA : 1, BGS : 2, SGC: 1, ViewonPSA: "")

class EdgeMaster : NSObject {
...
func UpdateEdge(EdgeMaster: EdgeMaster) {
